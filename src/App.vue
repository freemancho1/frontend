...
<div id="wrapper">
  <nav class="navbar is-dark">
    <div class="navbar-brand">
      <router-link to="/" class="navbar-item"><strong>Freeman</strong></router-link>
...
.lds-dual-ring:after {
  ...
  animation: lds-dual-ring 1.2s linear infinite;  // rotate time
}
...
.is-loading-bar {
  height: 0;
  overflow: hidden;
  -webkit-transition: all 0.3s;                  // Total animation run time
  transition: all 0.3s;
  &.is-loading {
    height: 80px;
  }
